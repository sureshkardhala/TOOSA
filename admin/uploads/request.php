...
$query = mysqli_query($db, "INSERT INTO request (book, description) VALUES ('$book', '$description')");
...
<head>
    ...
    <title>Upload Book detailes</title>
...
<form  action="request.php" method="POST"  >
  ...
  <h1><strong>Upload Book details</strong>  </h1>
  ...
  <div class="form-group">
    <label for="title">Book <span></span></label>
    <input type="text" name="book" id="title" class="form-controll"/>
  </div>
