...
<form  action="upload_video.php" method="POST"  enctype="multipart/form-data">
  ...
  <h1><strong>Video upload</strong>  </h1>
  ...
  <div class="form-group " >
    <label for="caption">YouTube Link <span></span></label>
    <input type="text" name="link" id="caption"  class="form-controll"/>
  </div>
  ...
  <div class="form-group" style="visibility:hidden;">
    ...
    <input type="text" name="choice" id="caption" required value="video" class="form-controll"/>
  </div>
