...
$query = mysqli_query($db, "INSERT INTO events (image, event, date, description, choice) VALUES ('$imgnewfile', '$event', '$date', '$description', '$choice')");
...
<form  action="upload_events.php" method="POST"  enctype="multipart/form-data">
  
  <h1><strong>Upload Events</strong>  </h1>
  ...
  <div class="form-group">
    ...
    <input type="text" name="event" id="title" class="form-controll"/>
  </div>
  ...
  <div class="form-group " >
    <label for="caption">Date <span></span></label>
    <input type="text" name="date" id="caption"  class="form-controll"/>
  </div>
  ...
  <div class="form-group" style="visibility:hidden;">
    ...
    <input type="text" name="choice" id="caption" required value="event" class="form-controll"/>
  </div>
