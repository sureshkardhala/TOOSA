...
$search=$_GET['search'];
$result=mysqli_query($db, "SELECT * FROM books WHERE categories LIKE '%".$search."%' OR subject LIKE '%".$search."%' OR name LIKE '%".$search."%' OR author LIKE '%".$search."%' OR publisher LIKE '%".$search."%'  ORDER BY uploaded_on DESC");
...
@media only screen and (max-width:480px){
    ...
    .msg{
                     ...
                     <div class="booksmedia-fullwidth">
                                ...
                                ?>
                                <div class="msg">
                                    <h1>No Results  found!.</h1><a href="admin/uploads/request.php">click here to request book </div>
                                    <?php
                                }
                                ?>
                            </div>
