...
$result=mysqli_query($db, "SELECT * FROM books WHERE categories='$categories' ORDER BY uploaded_on DESC");
...
@media only screen and (max-width:480px){
    ...
    .msg{
                                    ...
                                    <form action="search.php" method="get">
                                        ...
                                        <br>
                                        <div class="col-md-2 col-sm-6"id="sub-btn"  style="backgorund-color:#ff723;">
                     ...
                     <div class="booksmedia-fullwidth">
                                ...
                                ?>
                                <div class="msg">
                                    <h1>No Results found!.</h1><a href="request.php">click here to request book </div>
                                    <?php
                                }
                                ?>
                            </div>
